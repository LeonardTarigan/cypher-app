...
export default function Home() {
  ...
  return (
    <>
      <section className="flex justify-between rounded-xl bg-zinc-50 p-5 shadow-md dark:bg-zinc-900">
            ...
            {({ open }) => (
              <>
                ...
                >
                  <MenuItems
                    className={
                      "absolute right-0 mt-12 flex w-36 flex-col overflow-hidden rounded-xl bg-zinc-50 text-sm font-semibold shadow-xl dark:bg-zinc-800"
                    }
                  >
                    <MenuItem>
                      <Button
                        onClick={switchTheme}
                        className={`group flex items-center gap-2 p-3 transition-all duration-150 hover:bg-zinc-900 hover:text-zinc-100 dark:hover:bg-yellow-500 dark:hover:text-zinc-900`}
                      >
                        {theme === "light" ? (
