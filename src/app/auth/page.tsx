...
export default function AuthPage() {
  return (
    <div className="flex min-h-[90vh] w-full items-center justify-center">
      <section className="w-full bg-zinc-50 p-5 shadow-md dark:bg-zinc-900">
        ...
        <div className="space-y-1 text-zinc-50">
          <Button className="flex w-full items-center justify-center gap-2 bg-zinc-800 py-2 transition-all duration-150 hover:bg-zinc-700 active:scale-95">
